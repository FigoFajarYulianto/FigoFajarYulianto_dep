...
class LaporanController extends Controller
{
    ...
    {
        return view('fronts.laporan', [
            'kecamatans'    => Kecamatan::orderBy('name', 'ASC')->get(),
            'title_bar'    => ('Form Pengaduan'),
    ...
    public function store(Request $request)
    {
        ...
        $queryLaporan = LaporanDarurat::create($data);

        $dataLaporan = LaporanDarurat::firstWhere('id', $queryLaporan->id);
...
*II. KRONOLOGI*
    ...
    -Judul Pengaduan: ' . $dataLaporan->judul . '
    -Penjelasan Pengaduan: ' . $dataLaporan->kronologi . '
...
*III. LOKASI*
     ...
     -Alamat: ' . $dataLaporan->alamat . '';
        ...
        // kirim wa ke Pengadu
        $pesanKeAdmin = 'Kpd Yth. ' . $dataLaporan->name . ' , Pengaduan yang telah anda sampaikan telah tertampung yaitu dengan pengaduan ' . $dataLaporan->judul . ' . sebagai berikut.
