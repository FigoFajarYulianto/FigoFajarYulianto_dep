    ...
    <div class="col-12 grid-margin">
        <div class="card shadow">
            <div class="card-body">
                ...
                <form action="/dashboard/letters/{{ $letter->id }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mt-1 @error('pengirim_opd') is-invalid @enderror"
                                    name="pengirim_opd" id="pengirim_opd"
                                    value="{{ old('pengirim_opd', $letter->pengirim_opd) }}">
                                @error('pengirim_opd')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    name="pengirim_nonopd" id="pengirim_nonopd"
                                    value="{{ old('pengirim_nonopd', $letter->pengirim_nonopd) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control mt-1 @error('tgl_surat') is-invalid @enderror"
                                    ...
                                    value="{{ old('tgl_surat', $letter->tgl_surat ? date('Y-m-d', strtotime($letter->tgl_surat)) : '') }}">
                                @error('tgl_surat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control mt-1 @error('tgl_diterima') is-invalid @enderror"
                                    name="tgl_diterima" id="tgl_diterima"
                                    value="{{ old('tgl_diterima', $letter->tgl_diterima ? date('Y-m-d', strtotime($letter->tgl_diterima)) : '') }}">
                                @error('tgl_diterima')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mt-1 @error('nomor_surat') is-invalid @enderror"
                            name="nomor_surat" id="nomor_surat" value="{{ old('nomor_surat', $letter->nomor_surat) }}">
                        @error('nomor_surat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control mt-1 @error('perihal') is-invalid @enderror" name="perihal" id="perihal" rows="3">{{ old('perihal', $letter->perihal) }}</textarea>
                        @error('perihal')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control mt-1 @error('tgl_disposisi') is-invalid @enderror"
                                    name="tgl_disposisi" id="tgl_disposisi"
                                    value="{{ old('tgl_disposisi', $letter->tgl_disposisi ? date('Y-m-d', strtotime($letter->tgl_disposisi)) : '') }}">
                                @error('tgl_disposisi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control mt-1 @error('disposisi') is-invalid @enderror" name="disposisi"
                            id="disposisi" rows="5">{{ old('disposisi', $letter->disposisi) }}</textarea>
                        @error('disposisi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                                ...
                                <select name="irban_penerima" id="irban_penerima"
                                    ...
                                    @foreach (\App\Models\User::where('level_id', 5)->orderBy('name', 'ASC')->get() as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('irban_penerima', $letter->irban_penerima) == $item->id ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mt-1 @error('nama_penerima') is-invalid @enderror"
                                    ...
                                    value="{{ old('nama_penerima', $letter->nama_penerima) }}">
                                @error('nama_penerima')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control mt-1 @error('keterangan') is-invalid @enderror" name="keterangan" id="keterangan"
                            rows="5">{{ old('keterangan', $letter->keterangan) }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
