        ...
        <div class="card shadow">
            <div class="card-body">
                <div class="card-title text-uppercase">
                    <a href="/dashboard/links" class="mr-1"><i class="fa fa-arrow-circle-left"></i></a>
                    {{ $title_bar }}
                </div>
                <form action="/dashboard/links/{{ $link->id }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control mt-1 @error('name') is-invalid @enderror" name="name" type="text"
                            id="name" value="{{ old('name', $link->name) }}" />
                        @error('name')
                    ...
                    <div class="row">
                        <div class="col-md-2 mb-3">
                            <img src="{{ $link->image ? '/storage/' . $link->image : '/admin/img/noimage.jpeg' }}"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control mt-1 @error('link') is-invalid @enderror" name="link" type="text"
                            id="link" value="{{ old('link', $link->link) }}" />
                        @error('link')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
