                ...
                <form action="/dashboard/posts/{{ $post->id }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-2 mb-3">
                            <img src="{{ $post->image ? '/storage/' . $post->image : '/admin/img/noimage.jpeg' }}"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="ckeditor form-control @error('body') is-invalid @enderror" name="body" id="body">{{ old('body', $post->body) }}</textarea>
                        @error('body')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
