    ...
    <div class="col-12 grid-margin">
        <div class="card shadow">
            <div class="card-body">
                ...
                <form class="form-sample" action="/dashboard/sliders/{{ $slider->id }}" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-2 mb-3">
                            <img src="{{ $slider->desktop ? '/storage/' . $slider->desktop : '/admin/img/noimage.jpeg' }}"
                    ...
                    <div class="row mb-1">
                        <div class="col-md-2 mb-3">
                            <img src="{{ $slider->mobile ? '/storage/' . $slider->mobile : '/admin/img/noimage.jpeg' }}"
