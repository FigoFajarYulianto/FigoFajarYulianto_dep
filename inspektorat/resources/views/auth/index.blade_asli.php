                ...
                <div class="card-body">
                    ...
                    <form action="/auth/login" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('username') is-invalid @enderror" id="username" name="username" type="text" placeholder="Nama User" value="{{ old('username') }}" autofocus />
                            @error('username')
...
<div class="form-group mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('password') is-invalid @enderror" id="password" name="password" type="password" placeholder="Kata Sandi" />
                            @error('password')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
