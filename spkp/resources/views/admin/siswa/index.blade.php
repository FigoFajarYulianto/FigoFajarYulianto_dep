                ...
                <div class="card-header">
                    <div class="card-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalTambah"><i
                                class="fas fa-plus"></i> Tambah Siswa</button>
                    </div>
                </div>
                <div class="card-body">
            ...
            <div class="modal-content">
                ...
                <form id="formTambah">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="addNis">Username</label>
                            <input type="text" name="nis" class="form-control" id="addNis"
            ...
            <div class="modal-content">
                ...
                <form id="formEdit">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="editNis">Username</label>
                            <input type="text" name="nis" class="form-control" id="editNis"
                                placeholder="Masukan Username">
                        </div>
                        <div class="form-group">
