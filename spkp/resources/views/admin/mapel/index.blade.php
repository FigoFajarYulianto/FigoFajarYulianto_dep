                ...
                <div class="card-header">
                    <div class="card-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalTambah"><i
                                class="fas fa-plus"></i> Tambah Mapel</button>
                    </div>
                </div>
                <div class="card-body">
                ...
                <form id="formTambah">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="kode" class="form-control" id="addKode"
                ...
                <form id="formEdit">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="kode" class="form-control" id="editKode"
                                placeholder="Masukkan Kode Mapel">
                        </div>
                        <div class="form-group">
