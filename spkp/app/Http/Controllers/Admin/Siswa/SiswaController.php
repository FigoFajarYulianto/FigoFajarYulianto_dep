...
class SiswaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $kandidat['nama'] = $siswa->nama;
        $kandidat['siswa_id'] = $siswa->id;
        $kandidat_store = Kandidat::create($kandidat);

        $kandidat['id'] = $kandidat_store->id;
        $kandidat['periode'] = date('Y');
        RekapKandidat::create($kandidat);
    ...
    public function destroy(Siswa $siswa)
    {
        ...
        $kandidat = Kandidat::where('siswa_id', '=', $siswa->id);
        $kandidat->delete();
