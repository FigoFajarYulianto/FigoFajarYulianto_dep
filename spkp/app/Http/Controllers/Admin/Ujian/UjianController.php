...
class UjianController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $kriteria_data = Kriteria::where('nama', $request->nama)->first();
        if ($kriteria_data == null) {
            $kriteria['nama'] = $request->nama;
            $kriteria_pick = Kriteria::create($kriteria);
            $ujian->kriteria_id = $kriteria_pick->id;
        } else {
            $ujian->kriteria_pick = $kriteria_data->id;
        }
