...
<div id="layoutSidenav_content">
    <main>
        ...
        <div class="container-fluid px-4">
            <div class="card">
                <div class="card-body">
                    <div class="mb-3 card-title">Kategori Status Order
                        <a href="javascript:void(0)" class="ms-2 addstatusorders" data-bs-toggle="modal" data-bs-target="#statusordersModal"><i class="fa fa-plus-circle fa-lg"></i></a>
                    </div>
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="editstatusorders" data-id="{{ $row->id }}" data-bs-toggle="modal" data-bs-target="#statusordersModal">
                                        {{ $row->nama }}
                                    </a>
                                </td>
                                <td>
                                    <form action="/dashboard/statusorders/{{ $row->id }}" method="post">
                                        @csrf
                                        @method('DELETE')
