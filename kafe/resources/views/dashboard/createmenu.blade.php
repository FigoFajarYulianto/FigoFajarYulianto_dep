                    ...
                    <div class="row align-items-center justify-content-between pt-3">
                        <div class="col-auto mb-3">
                            <h1 class="page-header-title">
                                <div class="page-header-icon"><i class="fa-solid fa-utensils"></i></div>
                ...
                <div class="card-body">
                    ...
                    <form class="form-sample" action="/dashboard/menus/create" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control mt-1 @error('nama') is-invalid @enderror" name="nama" type="text" id="nama" value="{{ old('nama') }}" />
                            @error('nama')
                            ...
                            <div class="col-md-10 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="file" name="photo" id="photo" class="form-control @error('photo') is-invalid @enderror" onchange="previewImage('photo', 'photoPreview')">
                                        @error('photo')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="mb-3 col-sm-12">
                                ...
                                <select class="form-control mt-1 @error('category_id') is-invalid @enderror" name="category_id" id="category_id">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control mt-1 @error('harga') is-invalid @enderror" name="harga" type="number" id="harga" value="{{ old('harga') }}" />
                            @error('harga')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control mt-1 @error('diskon') is-invalid @enderror" name="diskon" type="number" id="diskon" value="{{ old('diskon') }}" />
                            @error('diskon')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
