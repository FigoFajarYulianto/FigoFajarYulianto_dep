        ...
        <div class="container-fluid px-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/dashboard/orders" method="get" class="mb-5 bg-light p-3 m-0 shadow-sm rounded">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-6">
                                    ...
                                    <select name="status_id" id="status_id" class="form-control form-control-sm mt-1">
                                        <option value="">:: Semua ::</option>
                                        <?php $order = \App\Models\Statusorder::orderBy('nama', 'ASC')->get(); ?>
