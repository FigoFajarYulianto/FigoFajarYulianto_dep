        ...
        <div class="card">
            <div class="card shadow">
                <div class="card-body">
                    ...
                    <form class="form-sample" action="/dashboard/orderitems/{{ $orderitem->id }}" method="post"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control mt-1 @error('qty') is-invalid @enderror" name="qty"
                                type="text" id="qty" value="{{ old('qty', $orderitem->qty) }}"
                                onkeyup="strToNum('qty')" />
                            @error('qty')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control mt-1 @error('harga') is-invalid @enderror" name="harga"
                                type="text" id="harga" value="{{ old('harga', $orderitem->harga) }}"
                                onkeyup="strToNum('harga')" />
                            @error('harga')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control mt-1 @error('diskon') is-invalid @enderror" name="diskon"
                                type="text" id="diskon" value="{{ old('diskon', $orderitem->diskon) }}"
                                onkeyup="strToNum('diskon')" />
                            @error('diskon')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('keterangan') is-invalid @enderror " name="keterangan" id="keterangan"
                                rows="5">{{ old('keterangan', $orderitem->keterangan) }}</textarea>
                            @error('keterangan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
