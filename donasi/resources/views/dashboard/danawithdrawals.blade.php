                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" class="editStatus" data-id="{{ $row->id }}"
                                            data-idfund="{{ $row->id }}" data-wallet="zakatfund" data-bs-toggle="modal"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label for="name">Dari Saldo</label>
                                    <input type="text" class="form-control" name="dana_id" id="dana_id" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="name">Penerima Zakat</label>
                                    <input type="text" class="form-control" name="penerima_dana" id="penerima_dana"
                                        readonly>
                                </div>
                            </div>
                        </div>
...
@section('script')
    <script>
        $('.editStatus').on('click ', function() {
            ...
            $('.modal form').prop('action', '/dashboard/verifikasidanawithdrawals/' + id);
            $('.modal-footer button[type=submit]').html('Perbarui');
            $.ajax({
                url: '/dashboard/verifikasidanawithdrawals/' + idfund,
                method: 'get',
                dataType: 'json',
                success: function(response) {
                    ...
                    $('#penerima_dana').val(response.penerima_dana);
                    $('#dana_id').val(response.dana.name);
