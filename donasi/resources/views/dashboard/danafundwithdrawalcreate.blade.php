            ...
            <div class="col-lg">
                <div class="card mb-4">
                    <div class="card-header text-uppercase">
                        <a href="/dashboard/danafundwithdrawals/{{ $dana->id }}" class="me-2"><i
                                class="fas fa-arrow-circle-left"></i></a>
                        {{ $title_bar }}
                    </div>
                    <div class="card-body">
                        {!! session('msg') !!}
                        <form action="/dashboard/danafundwithdrawals/{{ $dana->id }}/store" method="post"
                            enctype="multipart/form-data">
                            @csrf

                            <input type="hidden" name="bank_id" id="bank_id" value="{{ $banks->id }}">
                            <input type="hidden" name="dana_id" id="dana_id" value="{{ $dana->id }}">
                            <input type="hidden" name="danacategory_id" id="danacategory_id"
