            ...
            <div class="col-lg">
                <div class="card mb-4">
                    <div class="card-header text-uppercase">
                        <a href="/dashboard/danafundwithdrawals/{{ $danafunditem->dana->id }}" class="me-2"><i
                                class="fas fa-arrow-circle-left"></i></a>
                        {{ $title_bar }}
                    </div>
                    <div class="card-body">
                        {!! session('msg') !!}
                        <form action="/dashboard/danafundwithdrawals/{{ $danafunditem->id }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            <input type="hidden" name="bank_id" id="bank_id" value="{{ $danafunditem->bank_id }}">
                            <input type="hidden" name="dana_id" id="dana_id" value="{{ $danafunditem->dana_id }}">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="user_id">Nama</label>
                                        <input type="hidden" name="user_id" value="{{ $danafunditem->user_id }}" />
                                        <input class="form-control mt-1" type="text"
                                            value="{{ $danafunditem->user->name }}" readonly />
                                        @error('user_id')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label for="penerima_dana">Untuk (Penerima Dana)</label>
                                        <input class="form-control mt-1 @error('penerima_dana') is-invalid @enderror"
                                            type="text" name="penerima_dana"
                                            value="{{ old('bank', $danafunditem->penerima_dana ?? '') }}" />
                                        @error('penerima_dana')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="transaction_type"
                                            value="{{ old('bank', $danafunditem->transaction_type ?? '') }}" readonly>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control mt-1 @error('gross_amount') is-invalid @enderror"
                                            ...
                                            value="{{ old('bank', $danafunditem->gross_amount ?? '') }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control mt-1 @error('bank') is-invalid @enderror" name="bank"
                                            type="text" id="bank"
                                            value="{{ old('bank', $danafunditem->bank->bank ?? '') }}" readonly />
                                        @error('bank')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control mt-1 @error('nomor_rekening') is-invalid @enderror"
                                            ...
                                            value="{{ old('nomor_rekening', $danafunditem->bank->nomor ?? '') }}"
                                            readonly />
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-1 @error('description') is-invalid @enderror" name="description" id="description"
                                            cols="30" rows="10">{{ old('description', $danafunditem->description ?? '') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
