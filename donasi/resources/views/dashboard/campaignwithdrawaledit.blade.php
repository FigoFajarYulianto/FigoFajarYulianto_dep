        ...
        <div class="row">
            <div class="col-lg">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        {!! session('msg') !!}
                        <form action="/dashboard/campaignwithdrawals/{{ $campaignfunditem->id }}" method="post"
                            ...
                            <input type="hidden" name="campaign_id" id="campaign_id"
                                value="{{ $campaignfunditem->camapaign_id }}">
                            <div class="form-group mb-3">
                                <label for="user_id">Nama</label>
                                <input type="hidden" name="user_id"
                                    value="{{ old('user_id', $campaignfunditem->user->id) }}" />
                                <input class="form-control mt-1" type="text"
                                    value="{{ old('user_id', $campaignfunditem->user->name) }}" readonly />
                                @error('user_id')
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control mt-1 @error('gross_amount') is-invalid @enderror"
                                            ...
                                            value="{{ old('gross_amount', $campaignfunditem->gross_amount) }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-1 @error('description') is-invalid @enderror" name="description" id="description"
                                            cols="30" rows="10">{{ old('description', $campaignfunditem->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
