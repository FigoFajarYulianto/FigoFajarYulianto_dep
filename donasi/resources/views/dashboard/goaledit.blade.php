        ...
        <div class="row">
            <div class="col-lg">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        {!! session('msg') !!}
                        <form action="/dashboard/goals/{{ $goal->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group mb-3">
                                <label for="title">Judul</label>
                                <input class="form-control mt-1 @error('title') is-invalid @enderror" name="title"
                                    type="text" id="title" value="{{ old('title', $goal->title) }}" />
                                @error('title')
                            ...
                            <div class="row">
                                <div class="col-md-2 mb-3">
                                    <img src="{{ $goal->image ? '/storage/' . $goal->image : '/assets/img/noimage.jpeg' }}"
