            ...
            <div class="col-lg">
                <div class="card mb-4">
                    <div class="card-header text-uppercase">
                        <a href="/dashboard/testimonials" class="me-2"><i class="fas fa-arrow-circle-left"></i></a>
                        {{ $title_bar }}
                    </div>
                    <div class="card-body">
                        {!! session('msg') !!}
                        <form action="/dashboard/testimonials/{{ $testimonial->id }}" method="post"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control mt-1 @error('name') is-invalid @enderror" name="name"
                                    type="text" id="name" value="{{ old('name', $testimonial->name) }}" />
                                @error('name')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control mt-1 @error('title') is-invalid @enderror" name="title"
                                    type="text" id="title" value="{{ old('title', $testimonial->title) }}" />
                                @error('title')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-2 mb-3">
                                    <img src="{{ $testimonial->image ? '/storage/' . $testimonial->image : '/assets/img/noimage.jpeg' }}"
                            ...
                            <div class="form-group">
                                ...
                                <input required id="rateStar" name="rateStar" class="rating rating-loading"
                                    data-show-clear="false" data-show-caption="false" value="{{ $testimonial->star }}">
                            </div>
